...
- **Key Tasks Performed:**
  ...
  - Documented configuration and execution screenshots in [Experiment_1.pdf](Experiment_1.pdf).
...
- **Key Tasks Performed:**
  ...
  - Documented screenshots of network configuration, ping tests, and active chat in [Experiment_2.pdf](Experiment_2.pdf).
...
- **Key Tasks Performed:**
  ...
  - Documented network topology and connectivity verification screenshots in [Experiment_3.pdf](Experiment_3.pdf).
